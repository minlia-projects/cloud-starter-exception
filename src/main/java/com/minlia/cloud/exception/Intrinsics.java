...
public class Intrinsics {
  ...
  public static void isNull(Object parameter, Integer code, HttpStatus status, Object... arguments) {
    if (null == parameter) {
  ...
  private static void throwExceptionWithCodeAndArguments(Object code, HttpStatus status,
      Object... arguments) {
